...
def run_meshharm(mesh_path, save_path): 
    m = MeshHarm()
...
if __name__ == "__main__":
    ...
    blacklist = [
        'Data/fractal_output/day4/r0.zarr/B/01/0_fused/meshes/nnorg_linked/101.stl', 
        'Data/fractal_output/day4/r0.zarr/B/01/0_fused/meshes/nnorg_linked/105.stl'
    ]
        ...
        for well_name in wells[timepoint]:
            ...
            for label in tqdm(labels):
                ...
                if not os.path.exists(mesh_path):
                    ...
                    continue
                save_path = f"Data/fractal_output/{timepoint}/{zarr_name}/{well_name[0]}/{well_name[1:]}/{round_name}/meshharm_data"
                if not os.path.exists(save_path):
                    os.mkdir(save_path)
                save_path = f"{save_path}/{label}"
                if not os.path.exists(save_path + '_coeffs_v.npy'):
                    try: 
                        run_meshharm(mesh_path, save_path)
